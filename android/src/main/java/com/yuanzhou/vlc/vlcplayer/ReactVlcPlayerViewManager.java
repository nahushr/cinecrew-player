...
public class ReactVlcPlayerViewManager extends SimpleViewManager<ReactVlcPlayerView> {
  ...
  private static final String PROP_PLAY_WHEN_INACTIVE = "playWhenInactive";
  ...
  public void setPlayInBackground(final ReactVlcPlayerView videoView, final boolean play) {
    videoView.setPlayInBackground(play);
  }

  @ReactProp(name = PROP_PLAY_WHEN_INACTIVE, defaultBoolean = false)
  public void setPlayWhenInactive(final ReactVlcPlayerView videoView, final boolean play) {
    videoView.setPlayWhenInactive(play);
  }
  ...
  public void setAcceptInvalidCertificates(
      final ReactVlcPlayerView videoView, final boolean accept) {
