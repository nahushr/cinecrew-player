...
export default class VLCPlayer extends Component {
  ...
  render() {
    ...
    // React Native freezes props in development. Keep the resolved asset
    // immutable and build a private copy because the native source payload is
    // enriched below with VLC-only fields and init options.
